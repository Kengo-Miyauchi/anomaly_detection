...
df_normal = utils.fix_data(df_normal)
#print(df_normal.shape[1])
start = date + " " + start_time
end = date + " " + end_time
df_normal = utils.extract_specific_terms(df_normal,start,end,stampcol)
...
df_anomaly = utils.fix_data(df_anomaly)
start = date + " " + start_time
end = date + " " + end_time
df_anomaly = utils.extract_specific_terms(df_anomaly,start,end,stampcol)
